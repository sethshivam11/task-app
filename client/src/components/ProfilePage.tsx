...
const ProfilePage = () => {
  ...
  return (
    <main className="w-full flex flex-col items-center justify-center gap-10 2xl:p-16 xl:p-16 lg:p-16 md:p-10 p-6">
      <Button
        onClick={() => (window.location.href = "/")}
        size="default"
        className="absolute 2xl:left-20 xl:left-20 lg:left-20 md:left-10 left-10  top-10"
      >
        <ChevronLeft />
        Back to home
      </Button>
      ...
      {loading ? (
        ...
        <>
          <img
            src={user.avatar}
            className="h-32 w-32 rounded-full object-cover mb-8 cursor-pointer object-fill"
            alt=""
            onClick={() => setUpdateAvatarModal(true)}
          />
          <form className="w-full max-w-2xl" onSubmit={handleDetailsUpdate}>
          ...
          <form onSubmit={handlePasswordUpdate} className="w-full max-w-2xl">
